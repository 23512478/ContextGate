# 《AI 看不懂的 Java 写法再补两种：工厂方法返回值、方法内局部常量拼 SQL》

我在做一个 Java 静态分析工具（给 AI 看代码用的，[ContextGate](https://github.com/23512478/ContextGate)），项目里一直维护着一份"已知边界"清单：哪些 Java 写法追不动、为什么追不动，一条条写明白，不装能追。最近把清单从头复审了一遍，发现有两条当初归得草率了，这次顺手修掉。
